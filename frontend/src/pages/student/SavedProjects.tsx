    ...
    <div className="min-h-screen bg-[#f8f8f8]">
        ...
        <div className="mx-auto px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-12">
              <Link to="/student/dashboard" className="font-['Poppins'] text-[18px] text-black">
                Projects
              </Link>
              <div className="relative">
                <Link to="/student/saved-projects" className="font-['Poppins'] text-[18px] text-[#1a1851]">
                  Saved Projects
                </Link>
      ...
      <div className="container mx-auto px-8 py-8">
        <div className="flex gap-8">
          ...
          {/* Main Content - Saved Projects Grid */}
          <div className="flex-1">
            {/* Header */}
            <div className="flex items-end justify-between mb-8">
              <div>
                <h1 className="font-['Poppins'] font-semibold text-[32px] text-black">Saved Projects Collection</h1>
                <p className="font-['Poppins'] text-[20px] text-[#929292]">
                  {savedProjects.length} papers found
                </p>
              </div>
            </div>
            ...
            {loading ? (
              ...
              <div className="text-center py-20">
                ...
                <Button 
                  ...
                  className="bg-[#1a1851] hover:bg-[#16163f] text-white rounded-[8px] font-['Poppins']"
                >
                  Browse Papers
                </Button>
              </div>
